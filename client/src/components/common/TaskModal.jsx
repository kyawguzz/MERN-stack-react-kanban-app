import { Backdrop, Fade, IconButton, Modal, Box, TextField, Typography, Divider, Tooltip } from '@mui/material'
      ...
      <Fade in={task !== undefined}>
        <Box sx={modalStyle}>
          <Box sx={{
            ...
            <IconButton variant='outlined' style={{color: 'gray'}} onClick={onClose}>
                <CloseOutlinedIcon />
            </IconButton>
